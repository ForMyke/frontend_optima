                    ...
                    <div className="flex items-center justify-between">
                        <div>
                            ...
                            <p className="text-sm text-slate-600 mt-1">
                                Selecciona un administrativo para cargar automáticamente sus datos y sueldo base
                            </p>
                        </div>
                        ...
                        <div className="bg-blue-50 border border-blue-200 rounded-xl p-4 flex items-start gap-3">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-blue-700 mt-1">
                                    El sueldo base se toma del registro del administrativo seleccionado. En backend también debe validarse este valor antes de guardar.
                                </p>
                            </div>
                        </div>
                    )}
