...
const CreateAdministrativoModal = ({ isOpen, onClose, onSave }) => {
    ...
    <div className="fixed inset-0 backdrop-blur-xs bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-xl shadow-xl max-w-3xl w-full max-h-[90vh] overflow-y-auto">
        <div className="p-6 border-b border-slate-200">
          <h2 className="text-2xl font-bold text-slate-900">Nuevo administrativo</h2>
          <p className="text-sm text-slate-600 mt-1">
            Completa la información del personal administrativo
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="p-6">
          ...
          <div className="flex justify-end space-x-3 mt-6">
            ...
            >
              {isLoading ? 'Guardando...' : 'Guardar administrativo'}
            </button>
          </div>
        </form>
      </div>
