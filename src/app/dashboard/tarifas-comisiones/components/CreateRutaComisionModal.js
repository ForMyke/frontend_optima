...
const CreateRutaComisionModal = ({ isOpen, onClose, onSubmit, clientes }) => {
    ...
    <div className="fixed inset-0 backdrop-blur-xs bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-xl shadow-xl w-full max-w-2xl max-h-[90vh] overflow-y-auto">
        ...
        <div className="p-6 border-b border-slate-200">
          <h2 className="text-2xl font-bold text-slate-900">Nueva Comisión de Ruta</h2>
          <p className="text-sm text-slate-600 mt-1">Configurar comisión para una ruta específica</p>
        </div>
...
export default CreateRutaComisionModal
