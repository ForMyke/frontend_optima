    ...
    <div className="fixed inset-0 backdrop-blur-xs bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-xl shadow-xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
        <div className="p-6 border-b border-slate-200">
          <h2 className="text-2xl font-bold text-slate-900">Nueva refacción</h2>
          <p className="text-sm text-slate-600 mt-1">Registra una nueva refacción en el inventario</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="p-6">
          ...
          <div className="flex justify-end space-x-3 mt-6 pt-6 border-t border-slate-200">
            ...
            >
              {isLoading ? 'Guardando...' : 'Crear refacción'}
            </button>
          </div>
        </form>
      </div>
...
export default CreateRefaccionModal
